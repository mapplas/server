...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'admin',
        'HOST': '10.248.231.158',   						# Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SECRET_KEY = 'e3jg-x7@inergk1q1fz8*ujwr&wv68$a4z%m6!_)r(!o+_e829'
...
ROOT_URLCONF = 'mapplas_server.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'mapplas_server.wsgi.application'
